...
\end{slide}
  ...
  \begin{slide}
    ...
    Average turnaround time: $\mathsf{\frac{8 + 8 + 5 + 7}{4} = 7}$
    \medskip
  ...
  \begin{slide}
    ...
    Average turnaround time: $\mathsf{\frac{8 + 6 + 1 + 7}{4} = 5.5}$
    \medskip
  ...
  \begin{slide}
    ...
    Average turnaround time: $\mathsf{\frac{0 + 5 + 7 + 7}{4} = 4.75}$
    \medskip
  ...
  \begin{slide}
    ...
    \begin{itemize}
      ...
      \item SShortest Time-to-Completion (STCF) uses SJF ideas with preemptions
