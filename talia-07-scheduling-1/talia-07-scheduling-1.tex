...
\begin{slide}
    ...
    \begin{itemize}
        \item System call
        \item Program fault (i.e., segmentation fault, page fault)
        \item Interrupt 
    \end{itemize}
    \bigskip
...
\end{slide}
  ...
  \begin{slide}
	...
	\leftspace{} $T_{turnaround} = T_{completion} - T_{arrival}$
	...
	\leftspace{} (Different ways to measure)
	...
	Scheduling performance is application dependent.
...
\end{slide}
  ...
  \begin{slide}
	...
	SJF is optimal if we assume all jobs arrive at the same time.
  ...
  \begin{slide}
    ...
    \slidetitle{Shortest Time-to-Completion (STCF)}
    ...
    Similar to SJF, this optimizes the average turnaround time

  \end{slide}

  \begin{slide}

    \slidetitle{SRTF Reduces the Average turnaround Time Compared to SJF}
  ...
  \begin{slide}
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \fill [black!0] (0,0) rectangle (6em, 2em);
        
        \fill [black!0] (6em,0) rectangle (12em, 2em);

        \fill [black!0] (12em,0) rectangle (18em, 2em);

        \fill [black!0] (18em,0) rectangle (20em, 2em);

        \fill [black!0] (20em,0) rectangle (26em, 2em);

        \fill [black!0] (26em,0) rectangle (28em, 2em);

        \fill [black!0] (28em,0) rectangle (30em, 2em);

        \fill [black!0] (30em,0) rectangle (32em, 2em);
  ...
  \begin{slide}
    ...
    Average turnaround time: $\mathsf{\frac{10 + 14 + 15 + 16}{4} = 13.75}$
    \medskip
  ...
  \begin{slide}
    ...
    Average turnaround time: $\mathsf{\frac{15 + 12 + 6 + 16}{4} = 12.25}$
    \medskip
  ...
  \begin{slide}
    ...
    Average turnaround time: $\mathsf{\frac{7 + 11 + 12 + 16}{4} = 11.5}$
    \medskip
  ...
  \begin{slide}
    ...
    \leftspace{}Low average turnaround time (when job lengths vary)
    \bigskip
    ...
    RR has poor average turnaround time when jobs have similar lengths
  ...
  \begin{slide}
    ...
    \begin{itemize}
      ...
      \item Shortest Job First (SJF) is a tweak that reduces turnaround time
      \item Shortest Time-to-Completion (STCF) uses SJF ideas with preemptions
      \item STCF optimizes lowest turnaround time 
